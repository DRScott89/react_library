    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-teal-500 p-6'>
            <div className='flex items-center flex-shrink-0 text-white mr-6'>
                <Link to='/' className='font-semibold text-xl tracking-tight'>Coding Temple</Link>
            </div>
            <div className='block'>
            ...
            <div className='w-full block flex-grow items-center'>
                <div className="text-sm lg:flex-grow">
                    ...
                    <Button className="p-3 m-5 bg-teal-400 justify-center">
                        <div>
                            <Link to='/elib' onClick={ clicked } className='flex place-items-center mt-4 lg:inline-block lg:mt-0 
                            text-teal-200 hover:text-white mr-4'>
                                eLib
                            </Link>
                        </div>
                    ...
                    <Button className='p-3 m-5 bg-teal-400 justify-center'>
                        <div>
                            <Link to='/news' onClick={ clicked} className='flex place-itmes-center mt-4 lg:inline-block lg:mt-0
                             text-teal-200 hover:text-white mr-4'>
                                News
                            </Link>
                        </div>
